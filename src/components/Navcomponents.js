            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Garima Raj</div>
                            <div class="lead text-muted"><i class="bi bi-file-earmark-person"></i> A Learner | Web Developer</div>
                        </h1>
                        <hr />
                        <div class="contact">
                            <p class="lead pt-0">Im currently exploring various skills.</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:gforgarima933@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> VIT , Vellore</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/garima-raj-567990214/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/Garima-gam" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://drive.google.com/file/d/13PJmJX2qgCulus0_UkzIs7bRiTztU5M7/view?usp=drivesdk " target="_blank" class="btn btn-sm btn-danger fw-bold">Resume </a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="GARIMA RAJ">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/Garima-gam/TaskBS" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-primary border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/LeetCodeSolutions" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            <h4 class="card-header border-info text-center">Cloud Computing</h4>
                            <div class="card-body text-center py-4">
                                <h5 class="card-title">All of my works in this domain</h5>
                                <p class="card-text mx-3 my-1 text-muted d-none d-lg-block">Cloud computing is a technology that allows you to access and use various computing resources and services over the internet, rather than owning and maintaining your own physical hardware and software infrastructure.</p>
                                <a href="https://github.com/?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="list-group">
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="https://leetcode.com/problems/unique-number-of-occurrences/solutions/simple-and-intuitive-c-solution-unordered-map-and-set-beats-100/" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <small>Difficulty : Easy</small>
                                    <a href="https://leetcode.com/problems/isomorphic-strings/solutions/simple-and-intuitive-cpp-solution-beats-91-57-using-unordered-map-and-set/" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Garima Raj" required/>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select class="form-select" aria-label="Default select example" id="subject">
                                    ...
                                    <option value="Resume">Machine Learning</option>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="project-1" class="accordion-collapse collpase show" aria-labelledby="heading-1" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        <p>
                                            This is a Weather Forecasting tool or an app, which predicts an optimal weather from the collected moisture and other depending factors. 
                                        </p>
                                        <a href="https://fertilizer-forecast-app-kyw.streamlit.app/" class="btn btn-outline-danger me-2" >App</a>
                                        <a href="https://github.com/Fertilizer_Forecast" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="project-2" class="accordion-collapse collpase" aria-labelledby="heading-2" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://github.com/spam-sms-dectection" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
                        </div>
